...
`generate_self_signed` **只用于测试和受控内网**（`src/webapp/uvcpp_web_app.h:463-466`）。
...
| `uvcpp_web_app` | `src/webapp/uvcpp_web_app.cpp:1972` | 全库唯一"有人拥有"的一处：`std::shared_ptr<uvcpp_ssl_context>` |
