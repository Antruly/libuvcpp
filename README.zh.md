...
[![版本](https://img.shields.io/badge/version-1.3.20--dev-blue.svg)](./RELEASE.md)
...
- **版本**：`1.3.20-dev` — **作者**：`zhuweiye` — **许可证**：`MIT`
...
当前源码树是 **1.3.20-dev** —— 即 `UVCPP_VERSION_STRING`（`src/uvcpp/uvcpp_version.h`）
