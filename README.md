...
[![version](https://img.shields.io/badge/version-1.3.16--dev-blue.svg)](./RELEASE.md)
...
- **Version**: `1.3.16-dev` — **Author**: `zhuweiye` — **License**: `MIT`
...
The current source tree is **1.3.16-dev** — that is what `UVCPP_VERSION_STRING`
